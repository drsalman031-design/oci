...
import { View, Text, Pressable, ScrollView, Image, ActivityIndicator, Dimensions, Platform } from 'react-native';
import { 
  Sparkles, 
  CheckCircle2, 
  Cpu, 
      ...
      const markdown = await generateClinicalSummary(
        {
          ...
          dentitionPhase: selectedPreset === 'class2' ? 'Mixed Dentition' : 'Permanent Dentition'
        },
        measurements,
        mockOciResult
      );
