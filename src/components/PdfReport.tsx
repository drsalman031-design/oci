      ...
      <body class="bg-slate-100">
        ...
        <div class="pdf-page">
          ...
          <div class="flex-1 flex flex-col justify-center items-center space-y-8 my-auto">
            ...
            <div class="w-full max-w-lg p-6 bg-slate-50 rounded-3xl border border-slate-150 shadow-sm space-y-4">
              ...
              <div class="grid grid-cols-2 gap-4 text-xs">
                ...
                <div>
                  <p class="text-[8.5px] text-slate-400 font-black uppercase tracking-wider">Analysis Mode</p>
                  <p class="font-extrabold text-teal-600 mt-0.5 uppercase">${assessment.patientDetails.analysisMode === 'clinic' ? 'Clinic Mode' : assessment.patientDetails.analysisMode === 'ceph' ? 'Ceph Mode' : 'OCI Turbo Mode'}</p>
                </div>
                <div>
                  <p class="text-[8.5px] text-slate-400 font-black uppercase tracking-wider">Confidence Indicator</p>
                  <p class="font-extrabold text-indigo-600 mt-0.5 font-mono">${assessment.patientDetails.analysisMode === 'clinic' ? '85%' : assessment.patientDetails.analysisMode === 'ceph' ? '90%' : '98%'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="text-center text-[7px] text-slate-400 pt-4 border-t border-slate-150 font-mono" style="border-top: 1px solid #E2E8F0; padding-top: 10px;">
            <p style="font-weight: bold; margin-bottom: 2px;">Generated by OCI Analyzer™ • Version 3.0 • Page 1 of 6</p>
        ...
        <div class="pdf-page" style="width: 794px; height: 1123px; background-color: white; padding: 50px; box-sizing: border-box; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: space-between; page-break-after: always; break-after: page;">
          ...
          <div class="space-y-4" style="display: flex; flex-direction: column; gap: 16px;">
            <div style="display: flex; justify-between; align-items: center; border-bottom: 1px solid #E2E8F0; padding-bottom: 12px; margin-top: 16px;">
              <h3 style="font-size: 18px; font-weight: 900; color: #0F172A; text-transform: uppercase; margin: 0;">Clinical Photography & AI Overlay Analysis</h3>
              <span style="font-size: 9px; color: #94A3B8; font-family: monospace;">Page 3C of 6</span>
            </div>

            <p style="font-size: 10px; color: #64748B; line-height: 1.5; margin: 0;">
              Intelligent visual overlays generated by the OCI Clinical Photograph AI. Lines, landmarks, and convexity vectors indicate facial harmony parameters, lip margins, and midline axes.
            </p>

            <!-- 2x2 Photo Grid -->
            <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 16px; margin-top: 8px;">
              <!-- Photo 1: Frontal Rest -->
            ...
            <!-- Findings Checklist -->
            <div style="padding: 12px; background-color: #0F172A; border-radius: 12px; margin-top: 8px; color: white;">
              <p style="font-size: 9px; font-weight: 800; text-transform: uppercase; color: #22D3EE; margin-bottom: 6px; font-family: monospace; margin-top: 0;">OCI AI Photo Findings Summary</p>
              <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap-x: 16px; font-size: 8px;">
                ${findingsList}
              </div>
            </div>
          ...
          <div class="text-center text-[7px] text-slate-400 pt-4 border-t border-slate-150 font-mono" style="border-top: 1px solid #E2E8F0; padding-top: 10px; margin-top: 10px;">
            <p style="font-weight: bold; margin-bottom: 2px;">Generated by OCI Analyzer™ • Version 3.0 • Page 3C</p>
            <p style="font-style: italic; color: #64748B;"><strong style="text-transform: uppercase; font-weight: 800; color: #475569;">Clinical Decision Support Disclaimer:</strong> This report is generated using the OCI Analyzer™ (AI-Powered). OCI is intended to support orthodontic diagnosis and treatment planning. Final clinical decisions remain the responsibility of the treating orthodontist.</p>
          </div>
        </div>
        ` : ''}
