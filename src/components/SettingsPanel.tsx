    ...
    >
      <View style={tw`space-y-6 mt-6 max-w-xl mx-auto w-full`}>
        ...
        <View style={tw`bg-[#161A20] rounded-[20px] border border-[rgba(255,255,255,0.08)] overflow-hidden shadow-sm`}>
          ...
          {activeSection === 'profile' && (
            <View style={tw`p-5 border-t border-[rgba(255,255,255,0.08)] space-y-2`}>
              ...
              <Text style={tw`text-[10px] text-[#D9E2F2] font-mono`}>Role: Orthodontic Director • Clinical Administrator</Text>
            </View>
          )}
        </View>
        ...
        <View style={tw`bg-[#161A20] rounded-[20px] border border-[rgba(255,255,255,0.08)] overflow-hidden shadow-sm`}>
          ...
          {activeSection === 'security' && (
            <View style={tw`p-5 border-t border-[rgba(255,255,255,0.08)] space-y-2`}>
              ...
              <Text style={tw`text-[10px] text-[#D9E2F2] leading-normal`}>All patient data uploaded and saved locally is encrypted using AES-256-CBC with keys derived via PBKDF2 stretching.</Text>
            </View>
          )}
        </View>
          ...
          {activeSection === 'backup' && (
            <View style={tw`p-5 border-t border-[rgba(255,255,255,0.08)] space-y-4`}>
              <Pressable 
                ...
                style={tw`w-full py-3 bg-red-500/10 border border-red-500/20 rounded-xl items-center`}
              >
        ...
        <View style={tw`bg-[#161A20] rounded-[20px] border border-[rgba(255,255,255,0.08)] overflow-hidden shadow-sm`}>
          ...
          {activeSection === 'about' && (
            <View style={tw`p-5 border-t border-[rgba(255,255,255,0.08)] space-y-2`}>
              <Text style={tw`text-xs text-white font-bold`}>OCI Analyzer v4.1</Text>
              <Text style={tw`text-[10px] text-[#D9E2F2] leading-normal`}>The Orthodontic Compensation Index (OCI) is a specialized diagnostic indicator calculated from skeletal, dental, and soft tissue patterns. All rights reserved.</Text>
            </View>
          )}
        </View>
